...
function bm_future_git_reset_current_branch_to_origin {
...
function bm_future_git_checkout {
   ...
   git checkout -b ${bm_git_branch_checkout}  origin/${bm_git_branch_checkout} || git checkout ${bm_git_branch_checkout}
   export bm_git_branch_checkout=
}
