...
# +inversion_envelope+::  [Array, nil], if +nil+, the first colum of +reserved_tokens+ will be used. if an +Array+ whose elements are expected to be:
  ...
  def test__array_unflatten_base args=[]
    test_cases ||= [
      ...
      # TODO: BUG: in the command line it does not work
      # ./rubyment.rb  invoke_double p invoke_double  array_unflatten_base shell_array_deepen  "a" "[[" "b" "]]" c
      # ["a", "[[", "b", "]]", "c"]
      [
        "base_escape_case", [ :a, "[", :b, "]", :c], [
           :array_unflatten_base, [
...
=begin
  ...
  # note that the central elements (ie, in each column 1) are just like:
...
=begin
  TODO: can I execute pattern_exec__mapping_an_object
